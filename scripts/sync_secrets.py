...
SYNC_VARS = (
    ...
    "TIKTOK_SHOP_HOOK_DELIVERY",
    "TIKTOK_SHOP_CAPTION_MAX_CHARS_PER_LINE",
    "TIKTOK_SHOP_CAPTION_MAX_LINES",
    "TIKTOK_SHOP_CAPTION_FONT_SIZE",
    "FASTMOSS_API_BASE",
