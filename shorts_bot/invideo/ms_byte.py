...
def ms_byte_brief(
    *,
    ...
    parts = [
        ...
        "",
        "TEACH: price, one main use case, one honest flaw. Show real app UI.",
        "VERDICT: Pay / Skip / Wait / or name a BETTER tool — frame as wallet + job, NOT 'only for X type of person'.",
        "One condition only (e.g. pay if daily use; skip if $20 for occasional chat). Hedge once: mileage may vary.",
