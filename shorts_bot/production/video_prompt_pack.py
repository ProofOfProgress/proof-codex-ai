...
def _write_hook_guide(pack_dir: Path, hook: VideoPromptBrief, *, hybrid_hook: bool) -> None:
    ...
    lines = [
        ...
        "## Steps",
        "",
        "1. Generate cosy FLUX still from `prompts/00.00.txt` (or first segment still).",
        "2. Run I2V with prompt below + negative file — 3s max.",
        "3. Hard cut at 3s to stick-figure `images/00.01.png` (or next segment).",
